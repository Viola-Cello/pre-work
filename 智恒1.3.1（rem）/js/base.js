$(document).ready(function(){
   ...
   //new Clipboard('.btn-copy');
    ...
    //goods_card页面
    $(".goods-table button").click(function(){
	    $("button").removeClass('selected').children('img').animate({
	        right:'-0.14rem',
	        top:'-0.14rem'
	    },"fast");
    ...
    //business页面
 	$(".border-none button").click(function(){

         $("button").removeClass('active').find('div+img').animate({
                top:'-0.12rem'
            },"fast");
         ...
         $(this).addClass('active').find('div+img').animate({
                ...
                $(this).removeClass('active').find('div+img').animate({
                        top:'-0.12rem'
                    },"fast");
            });
